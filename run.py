...
msg = '''
You can try all sorts of formatting like _italics_ and *Kindly Click on The link to join the Group* or _*This Message is for testing purpose only*_. 

Multiline works too.

And so do links like https://chat.whatsapp.com/KSjYqr0xywsBJtfCtcJfIs
'''     
...
for index, number in enumerate(phone, 1):
    ...
    sleep(2)  # any delay is okay, even 0, but 3-5 seems appropriate
